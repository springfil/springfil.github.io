...
// По умолчанию лучше реализовывать конструкторы функций через замыкание, тк инкапсуляция. 
//когда нужен доступ до переменных, использовать Конструктор (св-ва объекта и this)
let x = 10;
