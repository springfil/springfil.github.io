...
//ремарка из комментов учебника
// Как декораторы расширяют и что-то делают с получаемой функцией, 
// так и геттеры и сеттеры расширяют возможности над свойствами объекта